...
class Visualizer():
    ...
    def display_current_results(self, visuals, epoch, name1,name2,ttt,save_result):
        ...
        if self.use_html and (save_result or not self.saved):  # save images to a html file
            ...
            for label, image_numpy in visuals.items():
                ...
                if(tt>0):
                    ...
                    name=name1
                img_path = os.path.join(self.img_dir,name+'_'+str(ttt)+'7'+'epoch%.3d_%s.png' % (epoch, label))
            ...
            for n in range(epoch, 0, -1):
                ...
                for label, image_numpy in visuals.items():
                    img_path = name+'_'+str(ttt)+'7'+'epoch%.3d_%s.png' % (n, label)
                    ims.append(img_path)
                    txts.append(label)
