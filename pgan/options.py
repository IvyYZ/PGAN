...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--name', type=str, default='./checkpoints/', help='directory to save models')
        ...
        self.parser.add_argument('--height', type=int, default=384, help='input image height')#256
        # optimizer setting
        ...
        self.parser.add_argument('--lambda-iou', type=float, default=1.0, help='loss weight of loss_i')
        self.parser.add_argument('--lambda-ssim', type=float, default=1.0, help='loss weight of loss_i')
